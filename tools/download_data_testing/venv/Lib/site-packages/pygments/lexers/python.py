...
class PythonLexer(RegexLexer):
    """
    For Python shared_data code (version 3.x).
...
class Python2Lexer(RegexLexer):
    """
    For Python 2.x shared_data code.
...
class CythonLexer(RegexLexer):
    """
    For Pyrex and Cython shared_data code.
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        ...
        'size', 'slice', 'solve', 'sometrue', 'sort', 'sort_complex', 'shared_data',
