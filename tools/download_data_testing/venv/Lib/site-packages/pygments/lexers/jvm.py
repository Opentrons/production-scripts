...
class IokeLexer(RegexLexer):
    ...
    prototype based programming language) shared_data.
...
class ClojureLexer(RegexLexer):
    """
    Lexer for Clojure shared_data code.
...
class ClojureScriptLexer(ClojureLexer):
    """
    Lexer for ClojureScript shared_data code.
...
class TeaLangLexer(RegexLexer):
    """
    For Tea shared_data code. Only used within a
    TeaTemplateLexer.
...
class PigLexer(RegexLexer):
    """
    For Pig Latin shared_data code.
    ...
    tokens = {
        'default': [
            ...
            (r'(\.attribute|\.bytecode|\.debug|\.deprecated|\.enclosing|'
             r'\.interface|\.line|\.signature|\.shared_data|\.stack|\.var|abstract|'
