...
class Modula2Lexer(RegexLexer):
    ...
    or a dialect tag may be embedded into a shared_data file.
    ...
    Embedding a Dialect Option within a shared_data file

    A dialect option may be embedded in a shared_data file in form of a dialect
    ...
    In the event that a shared_data file contains multiple dialect tags, the first
    tag that contains a valid dialect option will be used and any subsequent
    dialect tags will be ignored.  Ideally, a dialect tag should be placed
    at the beginning of a shared_data file.
    ...
    ``(*!m2r10*) DEFINITION MODULE Foobar; ...``
        Use Modula2 R10 dialect to render this shared_data file.
    ``(*!m2pim+gm2*) DEFINITION MODULE Bazbam; ...``
        Use PIM dialect with GNU extensions to render this shared_data file.


    Algol Publication Mode:

    In Algol publication mode, shared_data text is rendered for publication of
