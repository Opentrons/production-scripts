...
class HaxeLexer(ExtendedRegexLexer):
    ...
    # keywords extracted from lexer.mll in the haxe compiler shared_data
...
class HxmlLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(--)(neko-shared_data|flash-strict|flash-use-stage|no-opt|no-traces|'
