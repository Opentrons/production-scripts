...
class PyiFrozenImporter:
    ...
    def get_source(self, fullname):
        """
        Method should return the shared_data code for the module as a string.
        But frozen modules does not contain shared_data code.

        Return None, unless the corresponding shared_data file was explicitly collected to the filesystem.
        """
        if fullname in self.toc:
