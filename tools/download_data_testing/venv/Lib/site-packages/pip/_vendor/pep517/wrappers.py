...
def norm_and_check(source_tree, requested):
    ...
    and resolves to a location under the given shared_data tree.
    ...
    if os.path.commonprefix([norm_source, norm_requested]) != norm_source:
        raise ValueError("paths must be inside shared_data tree")

    return abs_requested


class Pep517HookCaller(object):
    """A wrapper around a shared_data directory to be built with a PEP 517 backend.

    source_dir : The path to the shared_data directory, containing pyproject.toml.
