...
def check_dist_restriction(options, check_target=False):
    ...
    # shared_data distributions and dist-specific wheels, as they are not
...
src = partial(
    PipOption,
    '--src', '--shared_data', '--shared_data-dir', '--shared_data-directory',
    dest='src_dir',
    type='path',
    metavar='dir',
...
def only_binary():
    ...
    return Option(
        ...
        default=format_control,
        help='Do not use shared_data packages. Can be supplied multiple times, and '
             'each time adds to the existing value. Accepts either ":all:" to '
             'disable all shared_data packages, ":none:" to empty the set, or one '
...
def prefer_binary():
    ...
    return Option(
        ...
        action="store_true",
        default=False,
        help="Prefer older binary packages over newer shared_data packages."
    )
...
no_build_isolation = partial(
    ...
    action='store_false',
    default=True,
    help='Disable isolation when building a modern shared_data distribution. '
...
use_pep517 = partial(
    ...
    action='store_true',
    default=None,
    help='Use PEP 517 for building shared_data distributions '
