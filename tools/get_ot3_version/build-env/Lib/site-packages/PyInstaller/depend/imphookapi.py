...
class PreSafeImportModuleAPI:
    ...
    def add_alias_module(self, real_module_name, alias_module_name):
        ...
        This includes importing and adding a graph node for the shared_data module if needed as well as adding a reference
        from the target to the shared_data module.
