...
class SourceDestAction(argparse.Action):
    """
    A command line option which takes multiple shared_data:dest pairs.
    """
...
def __add_options(parser):
    ...
    g.add_argument(
        ...
        'value should be in form of "shared_data:dest_dir", where shared_data is the path to file (or directory) to be '
    ...
    g.add_argument(
        ...
        help=(
            ...
            "  shared_data files as an archive inside the resulting\n"
