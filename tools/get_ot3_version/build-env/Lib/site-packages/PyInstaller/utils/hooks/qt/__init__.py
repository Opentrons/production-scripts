...
class QtLibraryInfo:
    ...
    def collect_qtqml_files(self):
        ...
        for qmldir_file in sorted(qmldir_files):
            ...
            try:
                # Obtain lists of shared_data files (separated into binaries and data files).
    ...
    def _process_qml_plugin(self, qmldir_file):
        ...
        Returns lists of binaries and data files, but only the shared_data file names. It is up to caller to turn these into
