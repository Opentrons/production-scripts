...
def compile_glib_schema_files(datas_toc, workdir, collect_source_files=False):
    ...
    output TOC, replacing any existing entry with that name. If `collect_source_files` flag is set, the shared_data XML
    ...
    # Copy schema (shared_data) files to temporary working directory
    ...
    # Include shared_data schema files in the output TOC (optional)
