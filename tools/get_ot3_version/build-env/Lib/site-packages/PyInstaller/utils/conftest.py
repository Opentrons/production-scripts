...
@pytest.fixture
def data_dir(
    # The request object for this test. Used to infer name of the test and location of the shared_data .py file.
    # See
...
class AppBuilder:
    ...
    def test_source(self, source, *args, **kwargs):
        """
        Test a Python script given as shared_data code.

        The shared_data will be written into a file named like the test-function. This file will then be passed to
