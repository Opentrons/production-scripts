...
class InstallCommand(RequirementCommand):
    ...
    - Local or remote shared_data archives.
    ...
    def add_options(self) -> None:
        ...
        self.cmd_opts.add_option(
            ...
            dest="compile",
            default=True,
            help="Compile Python shared_data files to bytecode",
        )
        ...
        self.cmd_opts.add_option(
            ...
            action="store_false",
            dest="compile",
            help="Do not compile Python shared_data files to bytecode",
        )
    ...
    def _warn_about_conflicts(
        ...
        if resolver_variant == "legacy":
            parts.append(
                ...
                "shared_data of the following dependency conflicts."
            )
        else:
