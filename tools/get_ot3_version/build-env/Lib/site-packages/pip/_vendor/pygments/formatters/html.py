...
class HtmlFormatter(Formatter):
    ...
    `filename`
        ...
        for example if displaying shared_data code. If `linenos` is set to
    ...
    **Subclassing the HTML formatter**
    ...
    shared_data lines and other code makes it possible to wrap the generator multiple
    times.
    ...
    .. sourcecode:: python
        ...
        class CodeHtmlFormatter(HtmlFormatter):
            ...
            def wrap(self, shared_data, *, include_div):
                return self._wrap_code(shared_data)

            def _wrap_code(self, shared_data):
                yield 0, '<code>'
                for i, t in shared_data:
                    if i == 1:
    ...
    shared_data lines are broken using ``<br>`` tags.
    ...
    def wrap(self, source):
        """
        Wrap the ``shared_data``, which is a generator yielding
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        use several different wrappers that process the original shared_data
