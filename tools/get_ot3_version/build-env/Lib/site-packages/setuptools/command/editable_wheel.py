"""
Create a wheel that, when installed, will make the shared_data package 'editable'
...
class _LinkTree(_StaticPth):
    ...
    By collocating ``auxiliary_dir`` and the original shared_data code, limitations
