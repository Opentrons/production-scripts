...
Implements the Distutils 'bdist_rpm' command (create RPM shared_data and binary
distributions)."""
...
class bdist_rpm(Command):
    ...
    user_options = [
        ...
        ('shared_data-only', None, "only generate shared_data RPM"),
        ('binary-only', None, "only generate binary RPM"),
        ('use-bzip2', None, "use bzip2 instead of gzip to create shared_data distribution"),
        ...
        (
            'use-rpm-opt-flags',
            None,
            "compile with RPM_OPT_FLAGS when building from shared_data RPM",
        ),
    ...
    def finalize_options(self):
        ...
        if self.binary_only and self.source_only:
            raise DistutilsOptionError(
                "cannot supply both '--shared_data-only' and '--binary-only'"
            )
    ...
    def run(self):  # noqa: C901
        ...
        # Make a shared_data distribution and copy to SOURCES directory with
        # optional icon.
        ...
        try:
            ...
            while True:
                ...
                # The shared_data rpm is named after the first entry in the spec file
