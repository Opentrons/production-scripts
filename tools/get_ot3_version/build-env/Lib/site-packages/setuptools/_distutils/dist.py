...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        #   command_options = { command_name : { option : (shared_data, value) } }
        ...
        # Python versions on the target platform, and '' for a shared_data
    ...
    def get_command_obj(self, command, create=1):
        ...
        if not cmd_obj and create:
            ...
            # we won't report the shared_data of the error.)
