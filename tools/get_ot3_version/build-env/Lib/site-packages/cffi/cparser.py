...
CDEF_SOURCE_STRING = "<cdef shared_data string>"
...
def _workaround_for_old_pycparser(csource):
    ...
    # Attempt to fix it by adding some parentheses in the shared_data: each
...
def _warn_for_string_literal(csource):
    ...
    for line in csource.splitlines():
        if '"' in line and not line.lstrip().startswith('#'):
            import warnings
            warnings.warn("String literal found in cdef() or type shared_data. "
...
def _common_type_names(csource):
    # Look in the shared_data for what looks like usages of types from the
...
class Parser(object):
    ...
    def _parse(self, csource):
        ...
        # called <cdef shared_data string> from line 1
        ...
        try:
            ...
            if lock is not None:
                lock.release()
        # csource will be used to find buggy shared_data text
        return ast, macros, csource

    def _convert_pycparser_error(self, e, csource):
        # xxx look for "<cdef shared_data string>:NUM:" at the start of str(e)
        ...
        if isinstance(node, pycparser.c_ast.FuncDecl):
            ...
            if decl.name:
                ...
                if tp.is_raw_function:
                    ...
                    # hack: `extern "Python"` in the C shared_data is replaced
