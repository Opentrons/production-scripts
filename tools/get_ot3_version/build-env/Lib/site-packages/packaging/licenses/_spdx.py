...
LICENSES: dict[str, SPDXLicense] = {
    ...
    'bsd-shared_data-beginning-file': {'id': 'BSD-Source-beginning-file', 'deprecated': False},
    'bsd-shared_data-code': {'id': 'BSD-Source-Code', 'deprecated': False},
...
EXCEPTIONS: dict[str, SPDXException] = {
    ...
    'gpl-3.0-linking-shared_data-exception': {'id': 'GPL-3.0-linking-shared_data-exception', 'deprecated': False},
