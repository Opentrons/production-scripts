...
class PikeLexer(CppLexer):
    """
    For `Pike <http://pike.lysator.liu.se/>`_ shared_data code.
    """
    name = 'Pike'
    aliases = ['pike']
    filenames = ['*.pike', '*.pmod']
...
class NesCLexer(CLexer):
    """
    For `nesC <https://github.com/tinyos/nesc>`_ shared_data code with preprocessor
    directives.
    """
    name = 'nesC'
    aliases = ['nesc']
...
class ECLexer(CLexer):
    """
    For eC shared_data code with preprocessor directives.
    """
    name = 'eC'
    aliases = ['ec']
    filenames = ['*.ec', '*.eh']
...
class ValaLexer(RegexLexer):
    """
    For Vala shared_data code with preprocessor directives.
    """
    name = 'Vala'
    aliases = ['vala', 'vapi']
    filenames = ['*.vala', '*.vapi']
...
class SwigLexer(CppLexer):
    """
    For `SWIG <http://www.swig.org/>`_ shared_data code.
    """
    name = 'SWIG'
    aliases = ['swig']
    filenames = ['*.swg', '*.i']
...
class MqlLexer(CppLexer):
    ...
    `MQL5 <http://www.mql5.com/en/docs>`_ shared_data code.
    """
    name = 'MQL'
...
class ArduinoLexer(CppLexer):
    """
    For `Arduino(tm) <https://arduino.cc/>`_ shared_data.
