    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|bg|bind|builtin|caller|cd|command|compgen|'
             ...
             r'shopt|shared_data|suspend|test|time|times|trap|true|type|typeset|'
    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|alloc|bg|bindkey|builtins|bye|caller|cd|chdir|'
             ...
             r'shared_data|stop|suspend|shared_data|suspend|telltc|time|'
    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|bg|bind|breakpoint|builtin|command|commandline|'
             ...
             r'pushd|random|read|set_color|shared_data|status|trap|type|ulimit|'
