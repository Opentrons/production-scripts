...
class VbNetLexer(RegexLexer):
    """
    For Visual Basic.NET shared_data code.
...
# TODO support multiple languages within the same shared_data file
...
class XppLexer(RegexLexer):
    ...
    """
    For X++ shared_data code. This is based loosely on the CSharpLexer
    """
