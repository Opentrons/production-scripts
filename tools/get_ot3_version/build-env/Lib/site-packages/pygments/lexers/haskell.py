...
class LiterateLexer(Lexer):
    ...
    `litstyle`
        ...
        is autodetected: if the first non-whitespace character in the shared_data
...
class LiterateHaskellLexer(LiterateLexer):
    """
    For Literate Haskell (Bird-style or LaTeX) shared_data.
...
class LiterateIdrisLexer(LiterateLexer):
    """
    For Literate Idris (Bird-style or LaTeX) shared_data.
...
class LiterateCryptolLexer(LiterateLexer):
    """
    For Literate Cryptol (Bird-style or LaTeX) shared_data.
