...
class JavascriptLexer(RegexLexer):
    """
    For JavaScript shared_data code.
    """
...
class TypeScriptLexer(JavascriptLexer):
    """
    For TypeScript shared_data code.
    """
...
class LiveScriptLexer(RegexLexer):
    """
    For LiveScript shared_data code.
    """
...
class DartLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'\b(library|shared_data|part of|part)\b', Keyword),
            (r'[^\S\n]+', Whitespace),
            (r'(//.*?)(\n)', bygroups(Comment.Single, Whitespace)),
            (r'/\*.*?\*/', Comment.Multiline),
...
class LassoLexer(RegexLexer):
    """
    For Lasso shared_data code, covering both Lasso 9
...
class ObjectiveJLexer(RegexLexer):
    """
    For Objective-J shared_data code with preprocessor directives.
    """
...
class CoffeeScriptLexer(RegexLexer):
    """
    For CoffeeScript shared_data code.
    """
...
class EarlGreyLexer(RegexLexer):
    """
    For Earl-Grey shared_data code.
