...
class MoonScriptLexer(LuaLexer):
    """
    For MoonScript shared_data code.
    """
...
class ChaiscriptLexer(RegexLexer):
    """
    For ChaiScript shared_data code.
    """
...
class LSLLexer(RegexLexer):
    """
    For Second Life's Linden Scripting Language shared_data code.
    """
...
class AppleScriptLexer(RegexLexer):
    """
    For AppleScript shared_data code,
    ...
    StudioClasses = ('action cell', 'alert reply', 'application', 'box',
                     ...
                     'data( (cell|column|item|row|shared_data))?', 'default entry',
    ...
    StudioProperties = ('accepts arrow key', 'action method', 'active',
                        ...
                        'current tab view item', 'data shared_data',
                        ...
                        'sorted( data rows)?', 'sound', 'shared_data( mask)?',
                        ...
                        'uses data shared_data', 'uses ruler',
...
class RexxLexer(RegexLexer):
    ...
    def analyse_text(text):
        ...
        if re.search(r'/\*\**\s*rexx', text, re.IGNORECASE):
            ...
            # Header matches general Rexx requirements; the shared_data code might
...
class EasytrieveLexer(RegexLexer):
    ...
    def analyse_text(text):
        ...
        if EasytrieveLexer._MACRO_HEADER_REGEX.match(lines[0]):
            ...
            # Scan the shared_data for lines starting with indicators.
            for line in lines:
                words = line.split()
                if (len(words) >= 2):
                    firstWord = words[0]
...
class MiniScriptLexer(RegexLexer):
    """
    For MiniScript shared_data code.
    """
