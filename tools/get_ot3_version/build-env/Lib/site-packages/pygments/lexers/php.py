...
class ZephirLexer(RegexLexer):
    """
    For Zephir language shared_data code.
...
class PhpLexer(RegexLexer):
    ...
    tokens = {
        ...
        'magicfuncs': [
            # shared_data: http://php.net/manual/en/language.oop5.magic.php
            (words((
        ...
        'magicconstants': [
            # shared_data: http://php.net/manual/en/language.constants.predefined.php
            (words((
