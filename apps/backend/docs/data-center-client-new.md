...
将 `data_center_client.py` 复制到任意目录即可使用，无需整个 `production-scripts` 项目。
...
```
apps/backend/scripts/data_center_client.py
apps/backend/docs/data-center-client-new.md   # 本文档
```
