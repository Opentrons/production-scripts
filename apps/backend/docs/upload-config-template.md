...
- `apps/backend/src/modules/uploads/handler/product_catalog.py`
- `apps/backend/src/modules/uploads/handler/parsers/definitions.py`
- `apps/backend/src/modules/uploads/handler/configs/upload_debug.yaml`
- `apps/backend/src/modules/uploads/handler/configs/upload_production.yaml`
...
如果新测试语义不属于已有 `TestTypes`，先在 `apps/backend/src/modules/uploads/handler/models/domain.py` 的 `TestTypes` 中增加枚举。
...
- `apps/backend/src/modules/uploads/handler/uploaders/`
- `apps/backend/src/modules/uploads/handler/repositories/upload_repository.py::default_upload_repositories()`
