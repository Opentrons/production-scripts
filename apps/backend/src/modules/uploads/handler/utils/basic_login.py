import os
from core.config import API_ROOT, TOKEN_PATH
from core.logging import get_logger

logger = get_logger(__name__)
PRODUCTION_PLATFORM_GOOGLE_HEALTH_CHECK_URL = os.getenv(
    "PRODUCTION_PLATFORM_GOOGLE_HEALTH_CHECK_URL",
    "https://www.googleapis.com/discovery/v1/apis/drive/v3/rest",
)
PRODUCTION_PLATFORM_GOOGLE_HEALTH_CHECK_TIMEOUT_SECONDS = int(os.getenv("PRODUCTION_PLATFORM_GOOGLE_HEALTH_CHECK_TIMEOUT_SECONDS", "30"))
...
def update_best_proxy():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(
            "node_test",
            API_ROOT / "ghelper-test" / "node_test.py"
        )
...
def google_drive_health_check():
    ...
    try:
        ...
        from modules.uploads.handler.drivers.google_drive import select_google_proxy_url
        from modules.uploads.handler.utils import runtime_config
        ...
        response = session.get(
            PRODUCTION_PLATFORM_GOOGLE_HEALTH_CHECK_URL,
            timeout=PRODUCTION_PLATFORM_GOOGLE_HEALTH_CHECK_TIMEOUT_SECONDS,
        )
