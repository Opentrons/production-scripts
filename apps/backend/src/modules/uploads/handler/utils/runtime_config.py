...
from core.config import API_ROOT, DOWNLOAD_DIR, GHELPER_DIR
...
USE_PROXY = _env_flag("PRODUCTION_PLATFORM_USE_PROXY", True)
_PROXY_UNSET = object()
...
def load_skill_config_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "production_backend_ghelper_skill_config",
