...
from core.config import CREDENTIALS_PATH, TOKEN_PATH
...
GOOGLE_API_TIMEOUT_SECONDS = int(os.getenv("PRODUCTION_PLATFORM_GOOGLE_UPLOAD_TIMEOUT_SECONDS", "180"))
PRODUCTION_PLATFORM_GOOGLE_PROXY_TEST_URL = os.getenv(
    "PRODUCTION_PLATFORM_GOOGLE_PROXY_TEST_URL",
    "https://www.googleapis.com/discovery/v1/apis/drive/v3/rest",
)
GHELPER_REFRESH_THREADS = int(os.getenv("PRODUCTION_PLATFORM_GHELPER_MONITOR_THREADS", "25"))
...
def refresh_best_proxy_config() -> bool:
    node_test_path = runtime_config.API_ROOT / "ghelper-test" / "node_test.py"
    ...
    try:
        ...
        best_node, best_proxy_url = node_test_module.get_best_proxy_and_update_config(
            ...
            test_url=PRODUCTION_PLATFORM_GOOGLE_PROXY_TEST_URL,
        )
