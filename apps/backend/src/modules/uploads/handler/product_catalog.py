...
from modules.uploads.handler.models import ProductionTypes, Productions, TestTypes

if TYPE_CHECKING:
    from modules.uploads.handler.parsers.definitions import CsvParserDefinition
...
def get_parser_definition(upload_config_key: str) -> CsvParserDefinition | None:
    ...
    from modules.uploads.handler.parsers.definitions import get_parser_definition as _get_parser_definition
