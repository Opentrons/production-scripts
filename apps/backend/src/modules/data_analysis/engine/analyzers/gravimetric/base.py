...
from modules.data_analysis.engine import gravimetric as gravimetric_analysis
from modules.data_analysis.engine.spec_store import get_gravimetric_spec
...
class GravimetricAnalyzer:
    ...
    def analyze(self, context: AnalysisContext) -> dict[str, Any]:
        result = gravimetric_analysis.analyze(context.file_path, context.rows, context.metadata)
