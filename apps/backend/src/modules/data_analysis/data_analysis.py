...
from modules.data_analysis.engine.spec_store import list_gravimetric_specs, save_gravimetric_spec
...
ANALYSIS_MAPPING_FILE = os.path.join(setting.API_ROOT, "configs", "data_analysis_mapping.yaml")
