...
GOOGLE_API_MAX_RETRIES = max(
    0,
    int(os.getenv("PRODUCTION_PLATFORM_GOOGLE_API_MAX_RETRIES", "5")),
)
GOOGLE_API_RETRY_BASE_SECONDS = max(
    0.1,
    float(os.getenv("PRODUCTION_PLATFORM_GOOGLE_API_RETRY_BASE_SECONDS", "2")),
)
GOOGLE_API_RETRY_MAX_SECONDS = max(
    GOOGLE_API_RETRY_BASE_SECONDS,
    float(os.getenv("PRODUCTION_PLATFORM_GOOGLE_API_RETRY_MAX_SECONDS", "60")),
)
