...
DEFAULT_DATAS_DIR = REPOSITORY_ROOT / "csv-samples" / "opentrons"
DEFAULT_DATAS_CONFIG_PATH = API_ROOT / "tests" / "datas_csv_config.json"
DEFAULT_REPORT_PATH = API_ROOT / "tests" / "reports" / "datas_csv_report.json"
DATAS_CASE_PROPERTY = "datas_case"

for import_path in (API_ROOT, SRC_ROOT):
