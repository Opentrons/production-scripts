...
Dog_Barking = str(resource_path('sounds', 'mixkit-dog-barking-twice-1.wav'))
Alarm_1 = str(resource_path('sounds', 'mixkit-classic-alarm-995.wav'))
Alarm_2 = str(resource_path('sounds', 'mixkit-alarm-tone-996.wav'))
voice = str(resource_path())
...
def _play_tone_with_afplay(frequency: int, duration_ms: int) -> None:
    tone_file = tempfile.NamedTemporaryFile(prefix='hardware-tone-', suffix='.wav', delete=False)
