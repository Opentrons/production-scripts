...
```text
apps/hardwares/src/tools/pipette_function_formating/
...
```text
apps/hardwares/src/tools/pipette_function_formating/ylcs.txt
```
...
```bash
uv run --package productions-hardwares python -m tools.pipette_function_formating.function_formating
```
