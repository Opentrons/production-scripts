...
from leveling_testing.type import TestNameLeveling, Direction
import csv
from typing import Any
from leveling_testing.config import LevelingSetting
from leveling_testing.errors import CsvWriteError
from leveling_testing.retry import retry_locked_file_action
from cli.interface import ui
from cli.report_contracts import LEVELING_REPORT_VERSION, LEVELING_TEST_NAME
import platform
...
class LevelingCSV:
    ...
    def _initial_rows(self) -> list[list[Any]]:
        ...
        rows.extend([
            ...
            _pad_row([0.01, "test-name", LEVELING_TEST_NAME]),
