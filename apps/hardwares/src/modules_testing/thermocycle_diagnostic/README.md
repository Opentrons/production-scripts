...
```text
apps/hardwares/src/resources/modules/tc_test_specification.json
```
...
```bash
uv run --package productions-hardwares python -m modules_testing.thermocycle_diagnostic.tc_diagnostic
```
...
- If the test specification changes, update `apps/hardwares/src/resources/modules/tc_test_specification.json` together with this README.
