<template>
  <div class="test-case-page" :style="{ '--tree-width': `${treeWidth}px` }">
    ...
    <main class="editor-pane">
      ...
      <el-alert
        v-if="deviceScanError && selectedCase"
        class="page-load-error"
        type="warning"
        :closable="false"
        show-icon
...
import TestCaseTree from '@/views/test_modules/components/TestCaseTree.vue'
...
async function loadAll() {
  ...
  try {
    ...
    console.error(error)
    loadError.value = normalizeTestManagementError(error)
  } finally {
    loading.value = false
  }
}
