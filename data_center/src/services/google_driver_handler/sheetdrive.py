...
sheettokenpath = os.path.join(BaseURL, 'sheettoken.json') if settings.debug else '/files_server/sheettoken.json'

class sheetdrive():
    def __init__(self) -> None:
        self.credentialspath = token_path
        self.sheettokenpath = sheettokenpath
