...
import os
from src.utils.main import zip_directory, delete_folder
import platform
from src.services.download_report_handler.download_files import get_time_str

router = APIRouter()
system = platform.system().lower()

if system == 'linux':
    LOCAL_PATH = '/src/datas'
else:
    LOCAL_PATH = './data'
...
async def flex_discover():
    ...
    scan flex
    """
    from src.services.flex_communications.discover_flex import scan_flex
