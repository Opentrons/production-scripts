...
class yamlfunc():
    ...
    def saveyaml(self,failpath,nama,data):
        """保存 YAML 文件"""
        fullpath = os.path.join(failpath,nama)
    ...
    def update_yaml(self,file_path,nama, key_path, new_value, backup=True):
        ...
        """
        # 可选：备份
        fullpath = os.path.join(file_path,nama)
        if backup:
...
if __name__ == "__main__":
    ...
    aa.update_yaml("/Users/yew/Desktop/production-scripts/data_center/google_driver_handler/","updata.yaml",["8ch_updata_volume",0,"movetestfail","Y2025","yue_1"],"1111",False)
